...
const login = async (req, res) => {
  try {
    ...
    if (user) {
      ...
      res.status(200).send({ success: false, message: "User Does Not Exists", data: null });
    }
  } catch (error) {
    res.status(400).send({
        success: false,
...
module.exports = { login, register, sendPasswordResetLink, resetPassword, verifyemail, getUserInfo, verifyEmailLink, updateProfile, updateUserEmail, updateUserPassword}